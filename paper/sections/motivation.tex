...
\num{CXL-SSD cold $\mu$s}; a hit in the software/device cache with a cold
PTE costs \num{soft $\mu$s}; a warm PTE hit costs \num{warm $\mu$s}
(Figure~\ref{fig:mot-cliff}). The ratio of the first to the last is
\num{$\sim$100--140$\times$}. Graph search multiplies this tax by hops
